...
set TOMCAT_DIR="C:\Tomcat\apache-tomcat-10.1.28"
...
REM Copie des JARs dans le répertoire WEB-INF/lib (sauf servlet-api.jar fourni par Tomcat)
echo Copie des JARs dans WEB-INF/lib...
for %%f in (%LIB_DIR%\*.jar) do (
    if /I not "%%~nxf"=="servlet-api.jar" (
